...
title = Label(root, text='SUDOKU', fg="#FFFFFF", font="Geneva 30", bg="#282828")
title.pack()
...
but = Canvas(root, width=500, height=45, background="#000000", bd=13, highlightthickness=0)
but.pack()
enter = Button(but, text="SUBMIT", fg="#000000", command=submit, font="Geneva 30 bold", bg='#FFFFFF',
               activebackground='#FFFFFF', highlightbackground="#FFFFFF", disabledforeground="#FFFFFF", justify=CENTER)
enter.configure(bg='#FFFFFF', width=8)
enter.place(x=10, y=10)
reset = Button(but, text="RESET", fg="#000000", command=scramble, font="Geneva 30 bold", bg='#FFFFFF',
               activebackground='#FFFFFF', highlightbackground="#FFFFFF", disabledforeground="#FFFFFF", justify=CENTER)
reset.configure(bg='#FFFFFF', width=8)
reset.place(x=300, y=10)
solve = Button(root, text="SOLVE", fg="#000000", command=pressed_solve, font="Geneva 30 bold", bg='#FFFFFF',
               activebackground='#FFFFFF', highlightbackground="#FFFFFF", disabledforeground="#FFFFFF", justify=CENTER)
solve.configure(bg='#FFFFFF', width=16, justify = CENTER)
solve.place(x=100, y=600)
